...
export default function SatelliteView() {
  ...
  return (
    <div className="p-8 max-w-[1600px] mx-auto space-y-10 animate-fade-in pb-24">
      ...
      {/* ════════════════════════════════════════════════════════════════════
          SECTION 3 — AIS/Satellite Detection Gallery
      ══════════════════════════════════════════════════════════════════════ */}
      <div>
        <div className="flex items-center gap-3 mb-6">
          <div className="w-1 h-6 bg-accent-primary rounded-full" />
          <h2 className="text-sm font-black text-text-primary tracking-tight uppercase">AIS/Satellite Detection Feed</h2>
        </div>
                  ...
                  >
                    ...
                    <div className="p-4 space-y-3 bg-bg-surface">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-[9px] font-black px-2 py-0.5 rounded border tracking-widest bg-status-danger/5 border-status-danger/20 text-status-danger">
                          SATELLITE
                        </span>
                      </div>
                            ...
                            <div className="pt-3 mt-3 border-t border-bg-border space-y-2">
                              <div className="grid grid-cols-2 gap-2">
                                <div className="p-2 rounded bg-bg-base border border-bg-border/50">
                                  ...
                                  <p className="text-[10px] font-black text-text-primary uppercase">{det.properties.source}</p>
                                </div>
                                <div className="p-2 rounded bg-bg-base border border-bg-border/50">
                                  <p className="text-[8px] font-black text-text-muted uppercase tracking-widest mb-1">Speed</p>
                                  <p className="text-[10px] font-black text-status-safe">{det.properties.speed} kn</p>
                                </div>
                              </div>
